            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/category">Karyawan</a></li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <a href="<?= base_url() ?>category/create" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Tambah Karyawan</a>
                        ...
                        <?php if (!empty($employee)) : ?>
                            <?php foreach ($employee as $e) : ?>
                                <tr>
                                    ...
                                    <td><span style="margin:0 15px"><?= $e['id_department']; ?></span></td>
                                    <td><span style="margin:0 15px"><?= $e['is_active']; ?></span></td>

                                    <td>
                                        <div class="d-flex gap-1" style="margin: 10px 15px">
                                            <a href="<?= base_url('employees/detail/' . $e['id']); ?>" class="btn btn-outline-info">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                    <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z" />
                                                    <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                                </svg>
                                            </a>
                                            <a href="/category/edit/<?= $e['id']; ?>" class="btn btn-outline-warning">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus <span style="color: red; font-weight: bold;"><?= $e['employee_name']; ?></span> dari data kategori?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Batal</button>
                                                            <form action="/category/delete/<?= $e['id']; ?>" method="post" style="display:inline;">
                                                                <?= csrf_field() ?>
