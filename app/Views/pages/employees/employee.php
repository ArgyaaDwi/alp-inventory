...
<section class="content">
    <div class="card">
        <div class="card-header">
            <a href="<?= base_url() ?>employees/create" class="btn" style="background-color: #00008B; color: white"><i class="fa-solid fa-plus"></i> Tambah Karyawan</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1" style="margin: 10px 15px">
                                        ...
                                        <a href="/employees/edit/<?= $e['id']; ?>" class="btn btn-outline-warning">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="/employees/delete/<?= $e['id']; ?>" method="post" style="display:inline;">
                                                            <?= csrf_field() ?>
